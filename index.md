...
<div style="border: 1px solid #ccc; padding: 10px; margin-bottom: 20px;">
    ...
    <img src="/assets/img/guys.png" alt="Protecting Eyes Image" style="max-width: 100%; height: auto;">
    <ol>
        <li>
...
The previous result brings up another question revolving aroung the same idea, but this time analyzing the the diversity of the cast in terms of community membership: how does the diversity of the cast influence the movie rating? To thoroughly analyze this question we will define diversity in 3 different ways. Let $$ n $$  be the number of communities and $$ P(x_i) $$ be the proportion of actors in the $$i$$th community relative to the total number of actors in a movie. Then we define diversity in the following 3 ways:
